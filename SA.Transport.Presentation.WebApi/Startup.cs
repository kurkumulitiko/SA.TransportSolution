...
using SA.Transport.Infrastructure.Files;
using SA.Transport.Presentation.WebApi.Extensions.Middlware;
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(s =>
                {
                    s.SwaggerEndpoint("/swagger/v1/swagger.json", "SA.Transport.WebApi");
                });
            }
